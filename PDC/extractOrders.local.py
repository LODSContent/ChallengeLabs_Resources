...
filePath = "/home/coder/challenge/orders/{}.json"
#filePath = "C:\\challenge-files-github\\python-data\\data\\{}.json"
...
for customer in customers:
    ...
    if len(orders) > 0:
        ...
        with open(filePath.format(customer["customerNumber"]),"w") as o:
