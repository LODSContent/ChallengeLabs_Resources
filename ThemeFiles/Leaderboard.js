 ...
 *              visibility with a green underline, respecting the page's default tab. Reverted leaderboard 
 *              name display and H3 player name from version 1.07 to fix tab display issue.
 */
