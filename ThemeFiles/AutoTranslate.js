...
if (autoTranslate === 'no') {
    ...
    const findElements = 'blockquote, table, a, p, h1, h2, h3, h4, ol, ul, li, details, span, input[type="button"], #labNotificationsHeader, #fullScreenMessageTitle, #custom-alerts-menu, #notificationContainer';
